 ...
 if(isset($_GET['ketqua']))
 {
  $ketqua = $_GET['ketqua'];
   ...
   //Neu Id khong co thi tra ve index
    ...
    $sql = "SELECT * FROM product WHERE name LIKE '$ketqua%'";
   // $sql = "SELECT * FROM product WHERE name LIKE '%$ketqua%'"; //lấy tất cả danh mục sp
    $timkiem = count($db->fetchsql($sql)); //tong so bản ghi
    $product = $db->fetchJones('product', $sql, $timkiem, $p, 4, true); //true = phân trang,ngược lại
    $sotrang = $product['page'];
    unset($product['page']);
   
    
    $path = $_SERVER['SCRIPT_NAME'];
   // $tk="SELECT * FROM product WHERE name LIKE '%$ketqua'";
   // $timkiem = count($db->fetchsql($tk));
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
                <div class="child-page">
                    <h1 class="title-cat">
                        <span>Kết quả tìm kiếm : <b><?php echo $ketqua;?></b></span>
                    </h1>
                    ...
                    <div class="category-product">
                        <div class="top-pro-list">
                            ...
                            <p class="woocommerce-result-count">
                                Có <?php echo $timkiem; ?> kết quả  cho từ khoá <b> <?php echo $ketqua; ?>
                            </p>
                                ...
                                <div class="dev-pt">
                                    <ul class="dev-mpt">
                                      <?php for ($i=1; $i <= $sotrang; $i++) :?>
                                        <li class="<?php echo isset($_GET['p']) && $_GET['p'] == $i ? 'active' : '' ?>"><a href="<?php echo $path ?>?ketqua=<?php echo $ketqua?>&id=<?php echo $id?>&&p=<?php echo $i ?>"><?php echo $i; ?></a></li>
                                          <?php endfor ; ?>
                                    </ul>
                                </div>
                                <!--end phan trang--->
