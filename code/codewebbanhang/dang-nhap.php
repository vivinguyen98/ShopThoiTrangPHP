                        ...
                        <section class="box-main1">
                            ...
                            <form action="" method="POST" class="form-horizontal formcustome" role="form" style="margin-top: 20px">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="email" name="email" placeholder="abcd@gmail.com" class="form-control" value="<?php echo $data['email'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="password" name="password" placeholder="*******" class="form-control" id="myInput" value="<?php echo $data['password'] ?>">
