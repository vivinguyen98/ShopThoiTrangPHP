<?php 
   ...
   $data =
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        {
            $error['phone'] = "Nhập lại số điện thoại!";
        }
                        ...
                        <section class="box-main1">
                            ...
                            <form action="" method="POST" class="form-horizontal formcustome" role="form" style="margin-top: 20px">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="name" placeholder="Phan Trung Hậu" class="form-control" value="<?php echo $data['name'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="email" name="email" placeholder="haupt@gmail.com" class="form-control" value="<?php echo $data['email'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" name="phone" placeholder="0927865478" class="form-control" value="<?php echo $data['phone'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="address" placeholder="TP.HCM" class="form-control" value="<?php echo $data['address'] ?>">
