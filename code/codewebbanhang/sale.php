<?php 
   ...
   //Neu Id khong co thi tra ve index
    ...
    $sql = "SELECT * FROM product WHERE sale > 0 order by price"; //lấy tất cả danh mục sp
                                ...
                                <div class="dev-pt">
                                    <ul class="dev-mpt">
                                      <?php for ($i=1; $i <= $sotrang; $i++) :?>
                                        <li class="<?php echo isset($_GET['p']) && $_GET['p'] == $i ? 'active' : '' ?>"><a href="<?php echo $path ?>?ketqua=<?php echo $timkiem?> &id=<?php echo $id?>&&p=<?php echo $i ?>"><?php echo $i; ?></a></li>
                                          <?php endfor ; ?>
                                    </ul>
                                </div>
                                <!--end phan trang--->
