    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
    {
        ...
        if(empty($error))
        {
            ...
            if($is_check != NULL)
            {
                ...
                echo "<script> alert('Đăng nhập thành công!'); location.href='/codewebbanhang/admin/' </script>";
            }
            else
            {
                //that bai
        ...
        <form role="form" action="" method="POST">
            <fieldset>
                ...
                <div class="form-group">
                    <input type="email" name="email" id="email" class="form-control input-lg" placeholder="Nhập Email">
                </div>
                <div class="form-group">
