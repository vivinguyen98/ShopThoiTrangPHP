                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input type="text" class="form-control" id="inputEmail3" placeholder="Đoàn Văn Đảm" name="name" value="<?php echo $data['name']?>">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input type="text" class="form-control" id="inputEmail3" placeholder="Đại học Công Nghệ Nghiệp Thực Phẩm TPHCM" name="address" value="<?php echo $data['address']?>">
