<?php
   ...
   {  
       ...
       if(postInput('password') != NULL && postInput('re_password')!= NULL )
       {
           ...
           {
               $data['password']= MD5(postInput('password')); // Mã hóa md5 cho mật khẩu
           }
       }
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input type="text" class="form-control" id="inputEmail3" placeholder="Đại học Công Nghệ TP.HCM" name="address" value="<?php echo $Editadmin['address']?>">
