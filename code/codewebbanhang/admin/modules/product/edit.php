                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <select class="form-control col-md-8" name="category_id">
                                      <option values="">---Chọn danh mục sản phẩm--- </option>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <textarea name="content" id="content" rows="10" cols="150" contenteditable="true"><?php echo $EditProduct['content']?></textarea>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <textarea name="info" id="content" rows="1" cols="50"><?php echo $EditProduct['info']?></textarea>
